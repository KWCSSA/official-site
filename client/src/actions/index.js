...
export const fetchAbout = () => async dispatch => {
  ...
  const res = {
    data: [
      { position: '主席', name: '赵铁柱', pic: 'http://localhost:8080/static/flavio.jpg', description: '外联部的主体职责分为两部分。一是负责筹集KWCSSA的所有日常与大型活动经费，如迎新会、好声音、滑大春晚，与赞助商进行沟通签约。我们现有的赞助商已有东方航空，RezOne，奔驰等。一般每位赞助商由外联部两部员以一主一副形势跟进。负责前期的proposal提出，中期的沟通协商以及后期的签约和收集反馈。' },
      { position: '主席', name: '赵铁柱', pic: 'http://localhost:8080/static/flavio.jpg', description: '外联部的主体职责分为两部分。一是负责筹集KWCSSA的所有日常与大型活动经费，如迎新会、好声音、滑大春晚，与赞助商进行沟通签约。我们现有的赞助商已有东方航空，RezOne，奔驰等。一般每位赞助商由外联部两部员以一主一副形势跟进。负责前期的proposal提出，中期的沟通协商以及后期的签约和收集反馈。' },
      { position: '主席', name: '赵铁柱', pic: 'http://localhost:8080/static/flavio.jpg', description: '外联部的主体职责分为两部分。一是负责筹集KWCSSA的所有日常与大型活动经费，如迎新会、好声音、滑大春晚，与赞助商进行沟通签约。我们现有的赞助商已有东方航空，RezOne，奔驰等。一般每位赞助商由外联部两部员以一主一副形势跟进。负责前期的proposal提出，中期的沟通协商以及后期的签约和收集反馈。' },
      { position: '主席', name: '赵铁柱', pic: 'http://localhost:8080/static/flavio.jpg', description: '外联部的主体职责分为两部分。一是负责筹集KWCSSA的所有日常与大型活动经费，如迎新会、好声音、滑大春晚，与赞助商进行沟通签约。我们现有的赞助商已有东方航空，RezOne，奔驰等。一般每位赞助商由外联部两部员以一主一副形势跟进。负责前期的proposal提出，中期的沟通协商以及后期的签约和收集反馈。' },
      { position: '主席', name: '赵铁柱', pic: 'http://localhost:8080/static/flavio.jpg', description: '外联部的主体职责分为两部分。一是负责筹集KWCSSA的所有日常与大型活动经费，如迎新会、好声音、滑大春晚，与赞助商进行沟通签约。我们现有的赞助商已有东方航空，RezOne，奔驰等。一般每位赞助商由外联部两部员以一主一副形势跟进。负责前期的proposal提出，中期的沟通协商以及后期的签约和收集反馈。' },
