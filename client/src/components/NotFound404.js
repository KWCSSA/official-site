  ...
  return (
    <div style={{height: '70vh', backgroundColor: '#fafafa', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      <div className="d-none d-md-flex flex-column">
        ...
        <div className="d-flex justify-content-center mt-4"><Link to='/' className="btn btn-dark btn-lg w-50">Go Back Home</Link></div>
      </div>
      <div className="d-flex d-md-none flex-column">
        ...
        <div className="d-flex justify-content-center mt-4"><Link to='/' className="btn btn-dark btn-lg w-75">Go Back Home</Link></div>
      </div>
    </div>
  );
};