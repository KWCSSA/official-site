        ...
        <li className="list-group-item">
          <div className="row">
            <div className="col-11">
              ...
              <textarea style={{ width: "100%", height: "300px" }} value={this.state.editingState.message.join('|')} onChange={e => this.handleInputChange('message', e.target.value)} />
              <label>日期：</label>
              <input style={{ width: "100%" }} value={this.state.editingState.date} onChange={e => this.handleInputChange('date', e.target.value)} />
            </div>
            <div className="col-1">
          ...
          <li className="list-group-item">
            <div className="row">
              <div className="col-11" style={{ minHeight: "100px" }}>
                {this.state.message.map((parag, i) => <p key={i} style={{marginBottom: '30px'}}>{parag}</p>)}
