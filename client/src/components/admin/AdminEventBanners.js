					...
					<div className='row'>
						<div className='col-11'>
							<div className='row'>
								<div className='col'>
									<h4>Banner:</h4>
									<div onClick={() => this.toggleModal(banner.pic.b)} style={{ cursor: 'zoom-in' }}>
										<img src={banner.pic ? banner.pic.b : ''} style={{ width: '100%' }} alt='' />
									</div>
									<input
										className='mt-2 mb-2'
										type='file'
										accept='image/jpeg'
										onChange={e => this.handleFileSelect(e.target.files[0], 'b')}
									/>
								</div>
							</div>
							<div className='row'>
								<div className='col'>
									<h4>Poster:</h4>
									<div onClick={() => this.toggleModal(banner.pic.p)} style={{ cursor: 'zoom-in' }}>
										<img src={banner.pic ? banner.pic.p : ''} style={{ width: '50%' }} alt='' />
									</div>
									<input
										className='mt-2 mb-2'
										type='file'
										accept='image/jpeg'
										onChange={e => this.handleFileSelect(e.target.files[0], 'p')}
									/>
								</div>
							</div>
							<div className='row'>
								<div className='col'>
									...
									<input
										style={{ width: '100%' }}
										value={this.state.addingState.link}
						...
						<div className='col-11'>
							...
							<div className='row'>
								<div className='col'>
									...
									<input
										style={{ width: '100%' }}
										value={this.state.editingState.link}
										onChange={e => this.handleInputChange(e.target.value)}
									/>
								</div>
							</div>
							...
							<li className='list-group-item' key={banner.id}>
								<div className='row'>
									...
									<div className='col-1 d-flex justify-content-center align-items-center'>
										<a className='d-flex' href={banner.link} target='_blank' rel='noopener noreferrer'>
									...
									<div className='col-1'>
										<button
											...
											style={{ width: '100%', height: '50px' }}
											onClick={() => {
												this.handleEditClick(banner.id);
											}}
										>
										...
										<button
											...
											style={{ width: '100%', height: '50px', marginTop: '10px' }}
											onClick={() => {
												this.handleDeleteClick(banner.id);
											}}
										>
