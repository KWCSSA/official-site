...
class AdminAboutList extends React.Component {
	...
	renderAbout() {
				...
				<div className='row'>
					...
					<div className='col-1'>
						<button
							...
							onClick={() => {
								this.handleEditClick(person.id);
							}}
						>
						...
						<button
							...
							onClick={() => {
								this.handleDeleteClick(person.id);
							}}
						>
		...
		const SortableEventItem = SortableElement(({ value }) => (
			<li className='list-group-item'>{renderAboutItem(value)}</li>
		));
					...
					<div className='row'>
						...
						<div className='col-10 d-flex flex-column'>
							<div className='d-flex flex-column'>
								<h4>照片:</h4>
								<div className='mt-3 mb-3' style={{ height: '500px' }}>
									<img
										style={{ maxHeight: '100%', maxWidth: '100%' }}
										src={person.pic}
										alt={person.position}
										onClick={() => this.toggleModal(person.pic)}
									/>
								</div>
							...
							<div>
								...
								<input
									...
									onChange={e => this.handleInputChange('position', e.target.value)}
								/>
							</div>
							<div>
								<h4>名字:</h4>
